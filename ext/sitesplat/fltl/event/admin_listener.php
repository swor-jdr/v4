	...
	*/
	...
	public function add_config($event)
	{
		if($event['mode'] == 'settings')
		{
			...
			{
				set_config('fltl_excluded_forums', json_encode($this->request->variable('fltl_excluded_forums', array(0))));
			}
			...
			$new_vars = array(
				...
				'fltl_time'	=> array('lang' => 'FLTL_TIME',	'validate' => 'int:4:20',	'type' => 'number:0:9999', 'explain' => true),
