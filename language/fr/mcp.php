...
$lang = array_merge($lang, array(
	...
	'CLOSE_REPORT'			=> 'Clôturer la demande',
	'CLOSE_REPORT_CONFIRM'	=> 'Êtes-vous sûr de vouloir clôturer la demande sélectionnée ?',
	'CLOSE_REPORTS'			=> 'Clôturer les demandes',
	'CLOSE_REPORTS_CONFIRM'	=> 'Êtes-vous sûr de vouloir clôturer les demandes sélectionnées ?',
	...
	'DELETE_REPORT'				=> 'Supprimer la demande',
	'DELETE_REPORT_CONFIRM'		=> 'Êtes-vous sûr de vouloir supprimer la demande sélectionnée ?',
	'DELETE_REPORTS'			=> 'Supprimer les demandes',
	'DELETE_REPORTS_CONFIRM'	=> 'Êtes-vous sûr de vouloir supprimer les demandes sélectionnées ?',
	...
	'LATEST_REPORTED'			=> 'Les 5 dernières demandes de modération',
	...
	'LIST_REPORTS'				=> array(
		1	=> '%d demande de modération',
		2	=> '%d demandes de modération',
	),
	'LOCK'						=> 'Verrouiller',
	...
	'MCP_POST_REPORTS'				=> 'Demandes émises pour ce message',
	...
	'NO_REPORT'						=> 'Aucune demande n’a été trouvée',
	'NO_REPORTS'					=> 'Aucune demande n’a été trouvée',
	'NO_REPORT_SELECTED'			=> 'Vous devez sélectionner au moins une demande pour effectuer cette action.',
	...
	'POST_REPORTED_SUCCESS'		=> 'Ce message attend une modération.',
	...
	'REPORTER'					=> 'Auteur de la demande',
	'REPORTED'					=> 'Demandé',
	'REPORTED_BY'				=> 'Demandé par',
	'REPORTED_ON_DATE'			=> 'le',
	'REPORTS_CLOSED_SUCCESS'	=> 'Les demandes sélectionnées ont été clôturées.',
	'REPORTS_DELETED_SUCCESS'	=> 'Les demandes sélectionnées ont été supprimées.',
	'REPORTS_TOTAL'				=> array(
		0	=> 'Il n’y a aucune demande à passer en revue.',
		1	=> 'Il y a <strong>1</strong> demande à passer en revue.',
		2	=> 'Au total, il y a <strong>%d</strong> demandes à passer en revue.',
	),
	'REPORT_CLOSED'				=> 'Cette demande a déjà été clôturé.',
	'REPORT_CLOSED_SUCCESS'		=> 'La demande sélectionnée a été clôturée.',
	'REPORT_DELETED_SUCCESS'	=> 'La demande sélectionnée a été supprimée.',
	'REPORT_DETAILS'			=> 'Détails de la demande',
	'REPORT_MESSAGE'			=> 'Contacter un MJ',
	'REPORT_MESSAGE_EXPLAIN'	=> 'Vous pouvez avoir recours à cette option si vous avez besoin d’une intervention extérieure. Cela peut s’agir d’une modération de votre jeu, signaler un cas de tricherie, demander une aide économique ou tout ce qui peut considérer le RP. Décrivez-nous bien la raison de votre demande en n’omettant aucun détail. Et surtout, considérez que nous ne sommes pas des machines, un peu de politesse et de ponctuation fait toujours plaisir. Vous pouvez également contacter un MJ pour signaler un manquement au règlement général de ce forum. <strong>Notez que rapporter un message privé rendra son contenu visible par tous les modérateurs.</strong>',
	'REPORT_NOTIFY'				=> 'M’informer',
	'REPORT_NOTIFY_EXPLAIN'		=> 'Vous informer quand votre demande a été traitée.',
	'REPORT_POST_EXPLAIN'		=> 'Vous pouvez avoir recours à cette option si vous avez besoin d’une intervention extérieure. Cela peut s’agir d’une modération de votre jeu, signaler un cas de tricherie, demander une aide économique ou tout ce qui peut considérer le RP. Décrivez-nous bien la raison de votre demande en n’omettant aucun détail. Et surtout, considérez que nous ne sommes pas des machines, un peu de politesse et de ponctuation fait toujours du bien. Vous pouvez également contacter un MJ pour signaler un manquement au règlement général de ce forum.',
	'REPORT_REASON'				=> 'Raison de la demande',
	'REPORT_TIME'				=> 'Date de la demande',
	'RESTORE'					=> 'Restaurer',
	...
	'RETURN_REPORTS'			=> '%sRetourner aux demandes de modérations%s',
